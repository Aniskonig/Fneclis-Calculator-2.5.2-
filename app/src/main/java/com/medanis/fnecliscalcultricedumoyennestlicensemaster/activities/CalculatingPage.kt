...
class CalculatingPage : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.getStringExtra("LEVEL+YEAR+SEMSTER") == "calledSemYear") {
//            CalculatingPage
        } else {
...
//                Log.e("sPECIALITY", sPECIALITY.toString())
                ...
                licenseMODULES = getModulesFromSharedPreferences(
                    this, mySPECIALITY_old, sPECIALITY[0], sPECIALITY[1]
                )!!
                ...
                saveRetrieveButton.setOnClickListener {
                    ...
                    Toast.makeText(
                        this, "Résultats modifiés avec succès", Toast.LENGTH_SHORT
                    ).show()
                }
            } else {
...
//                showADS()
                ...
                fun addMosules() {
                    if (mySPECIALITY == "License firstYEAR firstSEMSTER" || mySPECIALITY == "السّنة الأولى ليسانس، السّداسي الأوّل") {
                        ...
                        licenseMODULES.add(
                            MODULE(
                                "Langue étrangère 1 (Français et/ou anglais)", 2.2
                            )
                        )
                        ...
                        licenseMODULES.add(
                            MODULE(
                                "Langue étrangère 2 (Français et/ou anglais)", 2.2
                            )
                        )
                        ...
                        if (sPECIALITY == "Telecommunication" || sPECIALITY == "Génie biomédical" || sPECIALITY == "Electrotechnique" || sPECIALITY == "Electronique" || sPECIALITY == "Automatique" || sPECIALITY == "Electromécanique" || sPECIALITY == "Maintenance industrielle") {
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Electronique 1 et électrotechnique 1", 1.1
                                )
                            )
                        ...
                        if (sPECIALITY == "Telecommunication" || sPECIALITY == "Génie biomédical" || sPECIALITY == "Electrotechnique" || sPECIALITY == "Electronique" || sPECIALITY == "Automatique" || sPECIALITY == "Electromécanique" || sPECIALITY == "Maintenance industrielle") {
                            fun modTWO() {
                                licenseMODULES.add(
                                    MODULE(
                                        "Logique combinatoire et séquentielle", 2.0
                                    )
                                )
                                ...
                                if (sPECIALITY != "Maintenance industrielle") {
                                    ...
                                    licenseMODULES.add(
                                        MODULE(
                                            "Mesures électriques et électroniques", 2.1
                                        )
                                    )
                                }
                            }
                            ...
                            fun modTP() {
                                licenseMODULES.add(
                                    MODULE(
                                        "Techniques d'expression et de communication", 1.0
                                    )
                                )
                                licenseMODULES.add(
                                    MODULE(
                                        "TP Logique combinatoire et séquentielle", 1.1
                                    )
                                )
                            ...
                            if (sPECIALITY == "Telecommunication") {
                                ...
                                licenseMODULES.add(
                                    MODULE(
                                        "Télécommunications et applications", 1.0
                                    )
                                )
                                modTP()
                                licenseMODULES.add(
                                    MODULE(
                                        "TP Télécommunications fondamentale", 1.1
                                    )
                                )
                            } else if (sPECIALITY == "Automatique") {
                                licenseMODULES.add(
                                    MODULE(
                                        "Systèmes asservis linéaires et continus", 3.0
                                    )
                                )
                                modTWO()
                                ...
                                licenseMODULES.add(
                                    MODULE(
                                        "Architecture des Systèmes automatisés", 1.0
                                    )
                                )
                                modTP()
                                licenseMODULES.add(
                                    MODULE(
                                        "Tp Systèmes asservis linéaires et continus", 1.1
                                    )
                                )
                                ...
                                licenseMODULES.add(
                                    MODULE(
                                        "Production de l'énergie électrique", 1.0
                                    )
                                )
                                licenseMODULES.add(MODULE("Sécurité électrique", 1.0))
                                modTP()
                                licenseMODULES.add(
                                    MODULE(
                                        "Tp Electrotechnique fondamentale 2", 1.1
                                    )
                                )
                                ...
                                licenseMODULES.add(
                                    MODULE(
                                        "Systèmes de conversion de l'énergie", 1.0
                                    )
                                )
                                licenseMODULES.add(
                                    MODULE(
                                        "Notions de mesures électriques et électroniques", 1.0
                                    )
                                )
                                modTP()
                                licenseMODULES.add(
                                    MODULE(
                                        "Tp Mesures électriques et électroniques", 1.1
                                    )
                                )
                                ...
                                licenseMODULES.add(
                                    MODULE(
                                        "Tp Capteurs de grandeurs physiques", 1.1
                                    )
                                )
                            }
                            ...
                            if (sPECIALITY == "Aéronautique") {
                                ...
                                licenseMODULES.add(
                                    MODULE(
                                        "Valorisation des ressources minières", 3.0
                                    )
                                )
                                ...
                                licenseMODULES.add(
                                    MODULE(
                                        "Nomenclature des gisements miniers", 1.0
                                    )
                                )
                                modTP()
                                licenseMODULES.add(
                                    MODULE(
                                        "TP Valorisation des ressources minières", 1.1
                                    )
                                )
                                ...
                                licenseMODULES.add(
                                    MODULE(
                                        "TP Minéralogie et cristallographie", 1.1
                                    )
                                )
                            }
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Introduction au raffinage et à la pétrochimie", 1.0
                                )
                            )
                        ...
                        if (sPECIALITY == "Telecommunication") {
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Systèmes et réseaux de télécommunication", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Capteurs et mesures en télécommunications", 1.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Modélisation et identification des systèmes", 1.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Energies renouvelables : Production et stockage", 1.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Micro-processeurs et Microcontrôleurs", 1.1
                                )
                            )
                            licenseMODULES.add(MODULE("TP Electronique de puissance", 1.1))
                            licenseMODULES.add(
                                MODULE(
                                    "TP Modélisation et identification des systèmes", 1.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Organisation et méthode de la maintenance", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Gestion de la Maintenance Assistée par Ordinateur", 2.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Environnement et développement durable", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "TP d’Electronique et d’Electrotechnique appliquées", 1.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Technologie des composants électroniques 2", 1.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Terminologie et normes dans le biomédical", 1.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Equipements et circuits aéronautiques", 1.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Installations sanitaires et Assainissement", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Installations électriques", 2.0))
                            licenseMODULES.add(
                                MODULE(
                                    "Méthodes numériques appliquées (CAO+CFD)", 2.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Conception et Fabrication Assisté par Ordinateur", 2.3
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Méthodes d’analyses et de caractérisations", 2.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Notions de Système d’informations géographiques", 1.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Comportements mécanique des métaux et alliages", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Environnement minier : normes et législation", 1.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Sécurité des installations et des équipements industriels", 3.0
                                )
                            )
                            licenseMODULES.add(MODULE("Toxicologie industrielle", 2.0))
                            licenseMODULES.add(
                                MODULE(
                                    "Méthodes qualitatives d’analyse des risques", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Analyse des données et Outils statistiques", 1.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Phénomènes de surface et catalyse hétérogène", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Chimie physique (électrochimie, surface)", 1.1
                                )
                            )
                        ...
                        if (sPECIALITY == "Telecommunication") {
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Projet professionnel et gestion d'entreprise", 1.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Automates programmables industriels (API)", 3.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Bus de communications et réseaux industriels", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Installations électriques en automatique", 1.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Automates programmables industriels (API)", 1.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "TP Bus de communications et réseaux industriels", 1.1
                                )
                            )
                        } else if (sPECIALITY == "Electromécanique") {
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Automatismes et informatique industrielle", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Introduction au Moteur à combustion interne", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Technologie des machines thermiques et hydrauliques", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Outils de maintenance préventive conditionnelle", 1.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Réparations et interventions/TP MCI", 1.1
                                )
                            )
                        } else if (sPECIALITY == "Electronique") {
                            licenseMODULES.add(MODULE("Asservissements et régulation", 3.0))
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Electronique de puissance et impulsions", 1.1
                                )
                            )
                        } else if (sPECIALITY == "Electrotechnique") {
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Automatismes/ TP Matériaux et introduction à la HT", 1.1
                                )
                            )
                        } else if (sPECIALITY == "Génie biomédical") {
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Projet de Fin de Cycle (Milieu hospitalier)", 2.3
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Projet professionnel et Gestion de l\'entreprise", 1.0
                                )
                            )
                        } else if (sPECIALITY == "Génie climatique") {
                            licenseMODULES.add(
                                MODULE(
                                    "Installations de Climatisation et conditionnement d' air", 3.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Machines Frigorifiques et pompes à chaleur", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Machines Frigorifiques et pompes à chaleur", 1.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Dégradation et protection des matériaux", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Projet de Fin de Cycle", 2.3))
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Impact des Matériaux sur l’Environnement", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Technologie des conduites et équipements des réseaux", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP traitements thermi- ques et thermochimique des métaux", 2.3
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Procédés de mise en forme des métaux.", 1.1
                                )
                            )
                        } else if (sPECIALITY == "Travaux publics") {
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP chimie physique 2 et génie chimique 2", 1.1
                                )
                            )
                        } else if (sPECIALITY == "Exploitation des mines") {
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Méthodes quantitatives d’analyse des risques", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Pathologies professionne- lles et accidents de travail", 1.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Méthodes d'analyse des produits pétroliers", 1.1
                                )
                            )
                        }
                        ...
                        if (sPECIALITY == "Réseaux & Telecommunication") {
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Matière au choix :( Normes et Protocoles )", 1.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Techniques de fabrication Conventionnelles et avancées", 2.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Automatisation des systèmes industriels", 2.1
                                )
                            )
                            licenseMODULES.add(MODULE("Anglais technique et terminologie", 1.0))
                            licenseMODULES.add(
                                MODULE(
                                    "Matière au choix ( module du coeff = 1 )", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Signaux aléatoires et Processus stochastiques", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Matière au choix :( Compatibilité électromagnétique )", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Signaux aléatoires et Processus stochastiques", 1.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Classification hydraulique et pneumatique", 2.0
                                )
                            )
                            ...
                            if (sPECIALITY == "Automatique et Informatique industrielle") {
                                licenseMODULES.add(
                                    MODULE(
                                        "Réseaux et protocoles de communication industrielle", 2.1
                                    )
                                )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Traitement du signal / TP Optimisation", 1.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "TP Association convertisseurs-machines", 1.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Méthodes numériques appliquées et optimisation", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Méthodes numériques appliquées et optimisation", 1.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Modélisation et simulation des machines électriques", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Electronique de puissance avancée", 2.0))
                            licenseMODULES.add(
                                MODULE(
                                    "Mécanismes industriels et transmission de puissance", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Modélisation et simulation des machines électriques", 1.1
                                )
                            )
                            licenseMODULES.add(MODULE("TP Electronique de puissance avancée", 1.1))
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Mécanismes industriels et transmission de puissance", 1.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "TP Machines hydrauliques et pneumatiques", 1.1
                                )
                            )
                        } else if (sPECIALITY == "Electronique des systèmes embarqués") {
                            licenseMODULES.add(
                                MODULE(
                                    "Conception des systèmes à microprocesseurs", 3.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Electronique numérique avancée : FPGA et VHDL", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Traitement avancé du signal", 2.0))
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Conception des systèmes à microprocesseurs", 1.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Transfert de chaleur et de masse approfondi", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Notions de météorologie et Gisements renouvelables", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Méthodes numériques appliquées", 2.0))
                            licenseMODULES.add(
                                MODULE(
                                    "Energies Renouvelables et Enjeux énergétiques", 2.3
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Gisements renouvelables et météorologie", 2.3
                                )
                            )
                            licenseMODULES.add(MODULE("Anglais technique et terminologie", 1.0))
                            licenseMODULES.add(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Opérations unitaires du génie alimentaire", 3.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Process de transformations des aliments 1", 2.0
                                )
                            )
...
//                        )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Milieux poreux et dispersés", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Thermodynamique appliquée", 2.0))
                            licenseMODULES.add(
                                MODULE(
                                    "Echangeurs de chaleur", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Simulateurs en Génie des procédés", 2.1))
                            licenseMODULES.add(MODULE("Anglais technique et terminologie", 1.0))
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Ventilation et Conditionnement de l’Air I", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Travaux pratiques de Génie de l’environnement 1", 2.3
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Comportement mécanique des matériaux métalliques", 3.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Thermodynamique et diagrammes d’équilibre", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Structure cristallines et Défauts ponctuels", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Méthodes des éléments finis", 2.0))
                            licenseMODULES.add(
                                MODULE(
                                    "Elaboration et caractérisation des matériaux céramiques", 2.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Transfert thermique et Echangeurs de chaleur", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Simulateurs en génie des procédés", 2.1))
                            licenseMODULES.add(MODULE("Anglais technique et terminologie", 1.0))
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Opérations Unitaires (Fluide-Fluide)", 1.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "TP Transfert thermique et Echangeurs de Chaleur", 1.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Procédés de réfrigération et de liquéfaction des gaz", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Evaluation technicoéconomique des procédés", 1.3
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Production de matières premières et de monomères", 2.2
                                )
                            )
                            licenseMODULES.add(MODULE("TP chimie du pétrole", 2.3))
                            licenseMODULES.add(
                                MODULE(
                                    "TP Production de matières premières et de monomères", 2.3
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Chimie pharmaceutique I : Structure et Conception", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Systèmes d’Informations Géographiques (SIG)", 2.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Propriétés mécaniques des matériaux", 1.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Opérations unitaires de traitements des eaux (I)", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Hydrogéologie environnementale", 2.0))
                            licenseMODULES.add(
                                MODULE(
                                    "Microbiologie fondamentale et appliquée", 2.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Ressources en eau, pollution et Eco-Toxicologie", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Gestion et politique de l’eau/Droit de l’eau", 1.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Méthodes statistiques et échantillonnage", 1.0
                                )
                            )
                            licenseMODULES.add(MODULE("Anglais technique et terminologie", 1.0))
                            licenseMODULES.add(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Matière au choix :( module du coeff = 2 )", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Anglais technique et terminologie", 1.0))
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Physique des composants semiconducteurs 1", 3.0
                                )
                            )
                            licenseMODULES.add(MODULE("Couches minces", 2.0))
                            licenseMODULES.add(
                                MODULE(
                                    "Procédés d’élaboration des dispositifs semiconducteurs", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Conception des circuits intégrés analogiques", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Physique des composants semiconducteurs", 1.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "TP Conception des CI intégrés analogiques", 1.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Systèmes d’Informations Géographiques (SIG)", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Hydraulique numérique", 2.3))
                            licenseMODULES.add(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Solidification et procèdes d’élaboration", 3.0
                                )
                            )
                            licenseMODULES.add(MODULE("Matériaux polymères et composites", 3.0))
                            licenseMODULES.add(
                                MODULE(
                                    "Cristallographie et structure des matériaux", 3.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Materials Engineering and Technology : BM1", 6.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Technical English and Communication : BM7", 1.3
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Matière au choix :( module du coeff = 2 )", 2.2
                                )
                            )
                            licenseMODULES.add(MODULE("Anglais technique et terminologie", 1.0))
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Traitement avancé des signaux physiologiques", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Fonctions principales de l’électronique", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Circuits de conditionnement", 2.0))
                            licenseMODULES.add(
                                MODULE(
                                    "Technologies des biomatériaux pour prothèses", 2.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Traitement avancé des signaux /\n" + "TP Radiobiologie et radioprotection",
                                    1.1
                                )
                            )
                            licenseMODULES.add(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Outils math utilisés en Sureté de Fonctionnement", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Métho numé et matric d’analyse du risque", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Prévention et détection du risque incendie", 1.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Production de matières premières et de monomères", 2.2
                                )
                            )
                            licenseMODULES.add(MODULE("TP chimie du pétrole", 2.3))
                            licenseMODULES.add(
                                MODULE(
                                    "TP Production de matières premières et de monomères", 2.3
                                )
                            )
                        ...
                        if (sPECIALITY == "Réseaux & Telecommunication") {
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Canaux de transmission et Composants optiques", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Ethique, déontologie et propriété intellectuelle", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Matière au choix :( Réseaux d’opérateurs ou d'autres )", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Matière au choix :( Réseaux satellitaires  ou d'autres )", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "TP Administration des services réseaux", 1.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Matière au choix :( Techniques Radars ou d'autres )", 1.0
                                )
                            )
...
//                }
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Séparation magnétique et électrostatique", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Systèmes Embarqués et systèmes temps réels", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Systèmes Embarqués et systèmes temps réels", 1.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Concepts et langage de programmation graphique", 2.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Systèmes non linéaires/ TP Commande optimale", 1.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Modélisation et identification des systèmes électriques", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Asservissements échantillonnés et Régulation numérique", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Diagnostic des défaillances des systèmes de commande", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "TP Techniques de la commande électrique", 2.3
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Asservissements échantillonnés et Régulation numérique", 1.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Diagnostic des défaillances des systèmes de commande", 1.1
                                )
                            )
                        } else if (sPECIALITY == "Construction mécanique") {
                            licenseMODULES.add(MODULE("Méthode des éléments finis", 3.0))
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Systèmes mécaniques articulés et robotique", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Conception de systèmes mécanique", 2.0))
                            licenseMODULES.add(MODULE("CFAO", 2.1))
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Commande hydraulique et pneumatique", 1.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Processeurs des signaux numériques (DSP)", 3.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Processeurs des signaux numériques (DSP)", 1.1
                                )
                            )
                            licenseMODULES.add(MODULE("TP Systèmes à microcontrôleurs", 1.1))
                            licenseMODULES.add(
                                MODULE(
                                    "TP Capteurs intelligents / TP Réseaux industriels", 1.1
                                )
                            )
                        } else if (sPECIALITY == "Energétique") {
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Asservissement, régulation et métrologie thermique", 2.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Montage et Dimensionnement des projets ER", 2.3
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Process de transformations des aliments 2", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Microbiologie industrielle", 2.0))
                            licenseMODULES.add(
                                MODULE(
                                    "Propriétés physicochimiques des aliments", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Opérations unitaires du génie alimentaire 2", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Génie fermentaire et Biotransformation", 2.3
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Hygiène et sécurité dans le Génie Alimentaire", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Procédés d’Adsorption et séparation Membranaire", 2.0
                                )
                            )
//                        licenseMODULES.add(
//                            MODULE(
...
//                        )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Procédés d’adsorption et séparation Membranaire", 1.1
                                )
                            )
                        } else if (sPECIALITY == "Génie Climatique") {
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Ventilation et Conditionnement de l’Air II", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Régulation des systèmes climatiques", 1.1
                                )
                            )
                        } else if (sPECIALITY == "Génie de l’Environnement") {
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Propriétés physico-chimiques et Mécaniques des polymères", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Modélisation et simulation des matériaux", 2.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Elaboration et caractérisation des matériaux composites", 1.1
                                )
                            )
                        } else if (sPECIALITY == "Génie des Procédés de l’environnement") {
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Gestion et Traitement des déchets solides", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Traitement et Conditionnement des Eaux de process", 2.3
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "optimisation et Simulation des Procédés cryogéniques", 2.3
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Procédés de transformation en pétrochimie", 2.2
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Traitement et industrie du gaz naturel", 2.2
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Catalyseurs dans l’industrie pétrochimique", 2.2
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Ethique, déontologie et propriété intellectuelle", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Chimie pharmaceutique II : Classe Thérapeutiques", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Procédés d’Adsorption et Séparations Membranaires", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Réacteurs Polyphasiques et bioréacteurs", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Simulateurs en ingénierie pharmaceutique", 2.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Réacteurs Polyphasiques et bioréacteurs", 1.1
                                )
                            )
                        } else if (sPECIALITY == "Géotechnique") {
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Machines hydrauliques et stations de pompage", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Hydraulique Souterraine", 2.0))
                            licenseMODULES.add(
                                MODULE(
                                    "Modélisation et Simulation en hydraulique", 2.3
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Organisation et mécanisation des travaux", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Machines hydrauliques et stations de pompage", 1.1
                                )
                            )
                        } else if (sPECIALITY == "Ingénierie des Matériaux et des Surfaces") {
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Traitements thermiques et thermochimiques", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Endommagement et mécanique de la rupture", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Tribologie", 2.0))
                            licenseMODULES.add(
                                MODULE(
                                    "simulation des procédés de mise en forme", 2.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Techniques d’analyse et de caractérisation des matériaux", 2.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Opérations unitaires de traitements des eaux (II)", 3.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Procédés de traitement biologiques des eaux usées", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Procédés de traitements et gestion des rejets miniers", 1.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Maintenance des installations énergétiques", 2.1
                                )
                            )
                            licenseMODULES.add(MODULE("Asservissement et Régulation", 2.1))
                            licenseMODULES.add(
                                MODULE(
                                    "Ethique, déontologie et propriété intellectuelle", 1.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Champ magnétique dans les machines électriques", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Modélisation des machines électriques", 1.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Champ magnétique dans les machines électriques", 1.1
                                )
                            )
                        } else if (sPECIALITY == "Maintenance Industrielle") {
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Etique, déontologie et propriétés intellectuelle", 1.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Physique des composants semiconducteurs 2", 3.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Conception des circuits intégrés analogiques MOS", 2.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Géotechnique des ouvrages hydrauliques", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Géotechnique des ouvrages hydrauliques", 1.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Organisation et mécanisation des travaux", 1.1
                                )
                            )
                        } else if (sPECIALITY == "Réseaux Electriques") {
                            licenseMODULES.add(
                                MODULE(
                                    "Modélisation et optimisation des réseaux électriques", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Commande des systèmes électro-énergétiques", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Techniques de protection des réseaux électriques", 2.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Production centralisée et décentralisée", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Modélisation et optimisation des réseaux électriques", 1.1
                                )
                            )
                            licenseMODULES.add(MODULE("TP Qualité de l’énergie électrique", 1.1))
                            licenseMODULES.add(
                                MODULE(
                                    "TP Commande des systèmes électro-énergétiques", 1.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Mise en forme par déformation plastiques", 3.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Mise en forme des polymères et des composites", 3.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Casting and Polymer Processing-PART I : SM31", 5.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Machining and Joining Technology-PART I : SM2", 4.0
                                )
                            )
                            licenseMODULES.add(MODULE("Forming Technology PART I : SM1", 4.1))
                            licenseMODULES.add(
                                MODULE(
                                    "Production Management and Maintenance : SM4", 3.5
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Project and Laboratory Works II : PLW2", 5.1
                                )
                            )
                        } else if (sPECIALITY == "Voies et Ouvrages d'Art") {
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Systèmes d'Information Géographique (S.I.G)", 1.1
                                )
                            )
                        } else if (sPECIALITY == "Instrumentation Biomédicale") {
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Dispositifs spéciaux pour l’imagerie médicale", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Respect des normes et des règles d’éthique et d’intégrité", 1.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Analyse du cycle de vie et écoconception", 3.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Sécurité des procédés : risques mécaniques/électriques", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Sûreté de fonctionnement des systèmes 1", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Diagnostic des défaillances des systèmes industriels", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Logiciels informatiques dédiés à la sécurité industrielle", 2.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Ethique, déontologie et propriété industrielle", 1.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Traitements et industrie du gaz naturel", 1.0
                                )
                            )
                        ...
                        if (sPECIALITY == "Réseaux & Telecommunication") {
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Recherche documentaire et conception de mémoire", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Matière au choix :( Réseaux de terrain ou d'autres )", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "TP Réseaux sans fils et réseaux mobiles", 1.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Technologie et Protocoles pour le multimédia", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Dispositifs (Passifs/Actifs) RF et Micro-ondes", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Télévision numérique", 2.1))
                            licenseMODULES.add(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Réseaux Sans fil et réseaux mobiles", 1.1
                                )
                            )
                            licenseMODULES.add(MODULE("TP Communications optiques", 1.1))
                            licenseMODULES.add(
                                MODULE(
                                    "TP Technologie et Protocoles pour le multimédia", 1.1
                                )
                            )
                        }
...
//                }
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Traitement et gestion des rejets miniers", 3.0
                                )
                            )
                            licenseMODULES.add(MODULE("Métallurgie extractive", 2.0))
                            licenseMODULES.add(
                                MODULE(
                                    "Analyse et conception des procédés de séparation", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Automatisation des usines de traitement", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Recherche documentaire et conception du mémoire", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Commande électrique des mécanismes industriels", 3.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Techniques de l'intelligence artificielle", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Commande électrique des mécanismes industriels", 1.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Logiciels de simulation numérique en mécanique", 1.1
                                )
                            )
                        } else if (sPECIALITY == "Electromécanique") {
                            licenseMODULES.add(
                                MODULE(
                                    "Modélisation et simulation des systèmes électromécaniques", 3.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Organisation et gestion de la maintenance industrielle", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Conception Fabrication Assistée par Ordinateur CFAO", 2.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Systèmes embarqués / TP Systèmes Temps Réel", 1.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "TP Automates programmables industriels", 1.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Moteurs à combustion interne approfondi", 3.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Fluide de travail, Matériaux et dispositifs de Stockage", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Efficacité Energétique et thermique du bâtiment", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Solaire photovoltaïque et applications", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Piles à combustibles et production de l’hydrogène", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Etude Technico Economique et Gestion de Projets ER", 2.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Maintenance des systèmes à énergies renouvelables", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Interactions Atmosphère, Emballage, Aliment.", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Conduite de la Production Industrie Agroalimentaire", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Aliments fonctionnels et produits nouveaux", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Traitement des Déchets et Valorisation", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Planification et politique alimentaire", 1.0
                                )
                            )
                        } else if (sPECIALITY == "Génie Chimique") {
...
//                        )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Optimisation et Modélisation des procédés", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Plan d’expériences", 2.1))
                            licenseMODULES.add(MODULE("Intensification des procédés", 1.0))
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Procédés de traitements des effluents gazeux", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Régulation et commande des procédés", 2.1))
                            licenseMODULES.add(
                                MODULE(
                                    "Travaux pratiques de Génie de l’Environnement III", 2.3
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Optimisation des procédés industriels", 1.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "TP Equipement des Unités pétrochimiques", 1.1
                                )
                            )
                        } else if (sPECIALITY == "Génie des Matériaux") {
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Propriétés physiques et mécaniques des Céramiques", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Choix des matériaux", 2.0))
                            licenseMODULES.add(
                                MODULE(
                                    "Méthodes expérimentales et contrôle des matériaux", 2.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Traitements Physico-Chimique et Biologique des eaux usées", 3.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Technologie des Milieux poly phasiques", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Matériaux à Basse Température et Applications", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Procédés de purification des Gaz industriels", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Thermodynamique appliquée.", 2.0))
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "L’art du séminaire& Initiation à la Recherche", 1.2
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Simulation et optimisation des procédés", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Simulation des procédés chimiques", 2.0))
                            licenseMODULES.add(
                                MODULE(
                                    "Equipements des unités pétrochimiques", 2.2
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "TP Préparation des catalyseurs industriels", 2.3
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Technologie environnementale de l’industrie des HC", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Corrosion et protection des installations", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Recherche documentaire et conception de mémoire", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP CAO II :Simulation instationnaire des pro. chim", 1.1
                                )
                            )
                        } else if (sPECIALITY == "Génie Pharmaceutique") {
                            licenseMODULES.add(
                                MODULE(
                                    "Fabrication industrielle des médicaments", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Biopharmacie et pharmacocinétique", 2.0))
                            licenseMODULES.add(
                                MODULE(
                                    "Génie des Formulations pharmaceutiques", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Production d’eau pour les industries pharmaceutiques", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Régulation et commande des procédés", 2.0))
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Distribution et collecte des eaux urbaines", 3.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Epuration et réutilisation des eaux résiduaires", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Aménagement des cours d’eau et transport solide", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Management intégré des ressources en eau", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Techniques de reconnaissance et forage", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Formation et contrôle des microstructures fritées", 2.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Gestion des déchets et dépollution des sols et des nappes", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Recherche documentaire et conception de mémoire", 1.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Régimes transitoires des machines Electriques", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Commande des machines électriques", 2.0))
                            licenseMODULES.add(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Identification et diagnostique des machines électriques", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Régimes transitoires des machines électriques", 1.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Tribologie et Lubrification des systèmes mécaniques", 3.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Mécanique de la rupture et endommagements", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Acoustique appliquée", 2.0))
                            licenseMODULES.add(
                                MODULE(
                                    "Techniques de détection des défaillances", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Techniques de détection des défaillances", 1.1
                                )
                            )
                        } else if (sPECIALITY == "Matériaux en Génie Civil") {
                            licenseMODULES.add(MODULE("Matériaux composites", 2.0))
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Moteurs à combustion interne approfondi", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("Echangeurs de chaleur", 2.0))
                            licenseMODULES.add(MODULE("Optimisation", 2.1))
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Moteurs à combustion interne approfondi", 1.1
                                )
                            )
                            licenseMODULES.add(MODULE("TP CFD et logiciels", 1.1))
                            licenseMODULES.add(MODULE("TP Echangeurs de chaleur", 1.1))
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Techniques et Systèmes photovoltaïques", 3.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Conception des CI analogiques/numériques CMOS", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Optoélectronique et Circuits électroniques associés", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Physique des composants semiconducteurs 3", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Techniques et Systèmes photovoltaïques", 1.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "TP Conception des CI analogiques/numériques CMOS", 1.1
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Auscultation et surveillance des barrages", 1.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Stabilité et dynamique des réseaux électriques", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Stabilité et dynamique des réseaux électriques", 1.1
                                )
                            )
                            licenseMODULES.add(MODULE("TP Réseaux électriques industriels", 1.1))
                        } else if (sPECIALITY == "Ressources Hydrauliques") {
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Protection et gestion des ressources en eau", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Management intégré des ressources en eaue", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Ressources en eau et les changements climatiques", 1.0
                                )
                            )
                            licenseMODULES.add(MODULE("Management des projets", 1.0))
                            licenseMODULES.add(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Endommagement et mécanique de la rupture", 3.0
                                )
                            )
                            licenseMODULES.add(MODULE("C.A.O", 3.0))
                            licenseMODULES.add(
                                MODULE(
                                    "Microscopie analytique et spectroscopie", 3.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Techniques de Communication et d’Expression.", 1.0
                                )
                            )
                        } else if (sPECIALITY == "Technologies de Fabrication Mécanique") {
                            ttCoeff = 23
                            licenseMODULES.add(
                                MODULE(
                                    "Manufacturing Systems (Robotics/Automation) : BM4", 6.1
                                )
                            )
                            licenseMODULES.add(MODULE("Metrology and Quality : BM3", 4.0))
                            licenseMODULES.add(
                                MODULE(
                                    "Entrepreneurship and Innovation Management : BM6", 4.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Casting and Polymer Processing- PART II : SM32", 4.2
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Project and Laboratory Works III : PLW3", 5.1
                                )
                            )
                        } else if (sPECIALITY == "Voies et Ouvrages d'Art") {
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Instrumentation pour l’exploration fonctionnelle", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Instrumentation de l’imagerie médicale", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Gestion de projets pour les systèmes de santé", 2.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Modélisation et simulation des systèmes biomédicaux", 1.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Simulation des systèmes biomédicaux", 1.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Sûreté de fonctionnement des systèmes 2", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Méthodes intégrées d’analyse des risques", 2.0
                                )
                            )
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "Dimensionnement des équipements pétrochimique", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Corrosion et protection des installations", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Simulation et optimisation des procédés", 2.0
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "Stockage et transport des produits pétroliers", 2.0
                                )
                            )
                            licenseMODULES.add(MODULE("TP Corrosion", 2.3))
                            ...
                            licenseMODULES.add(
                                MODULE(
                                    "TP Préparation des catalyseurs industriels", 1.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
                                    "TP Simulation et optimisation des procédés", 1.1
                                )
                            )
                            licenseMODULES.add(
                                MODULE(
